...
HOW_TO_DOWNLD = environ.get('HOW_TO_VERIFY', "https://t.me/picturewallah0")
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "7")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "False")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/PICTUREWALLAH01')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/picturewallah0')
